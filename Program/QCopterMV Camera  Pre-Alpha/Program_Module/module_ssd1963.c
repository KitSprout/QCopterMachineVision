...
void TFT_DrawPicturePointU8( u16 CoordiX, u16 CoordiY, u16 Length, u16 Width, uc8 *Pic )
{
  ...
  u32 Point = 0;
	...
	for(i=0; i<Width; i++)	{
    for(j=0; j<Length; j++)	{
			TFT_DrawPoint(CoordiX+j, CoordiY+i, (u32)(Pic[Point+1]<<8 | Pic[Point]));
      Point+=2;
    }
	}
}
...
void TFT_DrawPicturePoint( u16 CoordiX, u16 CoordiY, u16 Length, u16 Width, uc16 *Pic )
{
  ...
  u32 Point = 0;
	...
	for(i=0; i<Width; i++)	{
    for(j=0; j<Length; j++)	{
			TFT_DrawPoint(CoordiX+j, CoordiY+i, (u32)(Pic[Point]));
      Point++;
    }
	}
}
...
void TFT_DrawPicture( u16 CoordiX, u16 CoordiY, u16 Length, u16 Width, uc16 *Pic )
{
  ...
  TFT_SetWindow(CoordiX, CoordiX+Length-1, CoordiY, CoordiY+Width-1);
  TFT_WriteCom(Com_WriteMemoryStart);
...
/*=====================================================================================================*/
/*=====================================================================================================*
**函數 : TFT_DrawGrayPicture
**功能 : Draw Gray Picture
**輸入 : CoordiX, CoordiY, Length, Width, Pic
**輸出 : None
**使用 : TFT_DrawGrayPicture(CoordiX, CoordiY, Length, Width, Pic)
**=====================================================================================================*/
/*=====================================================================================================*/
void TFT_DrawGrayPicture( u16 CoordiX, u16 CoordiY, u16 Length, u16 Width, uc8 *Pic )
{
  ...
  while(i--)
    TFT_WriteColor(RGB(Pic[i], Pic[i], Pic[i]));
}
/*=====================================================================================================*/
/*=====================================================================================================*
**函數 : TFT_PutChar1206
