...
**=====================================================================================================*/
/*=====================================================================================================*/
static void SCCB_Read( u8 SlaveAddr, u8 ReadAddr, u16* ReadBuf )
{
  u8 ReadData[2] = {0};
...
**=====================================================================================================*/
/*=====================================================================================================*/
static void SCCB_Write( u8 SlaveAddr, u8 WriteAddr, u16 WriteBuf )
{
  u8 WriteData[2] = {0};
...
//  RCC_MCO2Config(RCC_MCO1Source_PLLCLK, RCC_MCO1Div_3);
  ...
  /* CAM_STANDBY PB3 */  /* CAM_OE PB4 */  /* CAM_EXPOSURE PB5 */
  ...
  /* DCMI Config ************************************************************/
  DCMI_InitStruct.DCMI_CaptureMode = DCMI_CaptureMode_SnapShot; // DCMI_CaptureMode_Continuous;
  ...
  DMA_InitStruct.DMA_Memory0BaseAddr = (u32)ImageBuf; //FSMC_LCD_ADDRESS;
  DMA_InitStruct.DMA_DIR = DMA_DIR_PeripheralToMemory;
  DMA_InitStruct.DMA_BufferSize = FULL_IMAGE_SIZE/4;
