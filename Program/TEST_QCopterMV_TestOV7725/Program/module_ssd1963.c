...
**=====================================================================================================*/
/*=====================================================================================================*/
void TFT_DrawPicture( u16 CoordiX, u16 CoordiY, u16 Length, u16 Width, uc8 *Pic )
{
  ...
  u32 point = 0;
    ...
    for(j=0; j<Width; j++)	{
			...
			ColorR = Pic[point++];
      point++;
			TFT_DrawPoint(CoordiX+i, CoordiY+j, (u32)RGB(ColorR, ColorG, ColorB));
    }
	}
}
/*=====================================================================================================*/
...
void TFT_DrawGrayPicture( u16 CoordiX, u16 CoordiY, u16 Length, u16 Width, uc8 *Pic )
{
  ...
  u8 ToGary = 0;
    ...
    for(j=0; j<Width; j++)	{
			...
			ColorR = Pic[point++];
      point++;
      ToGary = RGB_TO_GARY(ColorR, ColorG, ColorB);
			TFT_DrawPoint(CoordiX+i, CoordiY+j, (u32)RGB(ToGary, ToGary, ToGary));
    }
	}
}
/*=====================================================================================================*/
