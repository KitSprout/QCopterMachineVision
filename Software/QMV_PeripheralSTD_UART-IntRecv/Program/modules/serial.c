...
/*====================================================================================================*/
#define UARTx                       USART6
#define UARTx_CLK_ENABLE()          RCC_APB2PeriphClockCmd(RCC_APB2Periph_USART6, ENABLE)
#define UARTx_IRQn                  USART6_IRQn

#define UARTx_TX_PIN                GPIO_Pin_14
#define UARTx_TX_GPIO_PORT          GPIOG
#define UARTx_TX_AF                 GPIO_AF_USART6
#define UARTx_TX_SOURCE             GPIO_PinSource14

#define UARTx_RX_PIN                GPIO_Pin_9
#define UARTx_RX_GPIO_PORT          GPIOG
#define UARTx_RX_AF                 GPIO_AF_USART6
#define UARTx_RX_SOURCE             GPIO_PinSource9
