...
#define MPU6500M_4800uT   ((float)0.6f)             // 0.6 uT/LSB

/* ---- MPU6500 Reg In MPU6500 ---------------------------------------------- */

#define MPU6500_I2C_ADDR            ((uint8_t)0xD0)
#define MPU6500_DeviceID            ((uint8_t)0x70) // In MPU6500
...
void    MPU6500_Mag_WriteReg( uint8_t writeAddr, uint8_t writeData );
void    MPU6500_Mag_WriteRegs( uint8_t writeAddr, uint8_t *writeData, uint8_t lens );
uint8_t MPU6500_Mag_ReadReg( uint8_t readAddr );
void    MPU6500_Mag_ReadRegs( uint8_t readAddr, uint8_t *readData, uint8_t lens );
